  ...
  async loadBlockchainData(dispatch) {
    if(typeof window.ethereum!=='undefined'){
      ...
      if(typeof accounts[0] !=='undefined'){
        ...
        this.setState({account: accounts[0], balance: balance, web3: web3, balanceEther: balanceEther})
      } else {
      ...
      try {
        ...
        const tokenBalanceEther = web3.utils.fromWei(tokenBalance, 'ether')
        const dbankBalance = await web3.eth.getBalance(dBankAddress)
        const dbankBalanceEther = web3.utils.fromWei(dbankBalance, 'ether')

        if (typeof dbankBalance == 'undefined'){
          dbankBalanceEther = 0;
        }

        this.setState({token: token, dbank: dbank, dBankAddress: dBankAddress, tokenBalanceEther: tokenBalanceEther, dbankBalanceEther: dbankBalanceEther})
      } catch (e) {
        console.log('Error', e)
